<template>
  <ProfileWizard>
    ...
    <ButtonBar>
      <v-btn to="/2sv/printable-backup-codes/intro" color="primary" tabindex="-1" outlined class="mb-4"> 
        {{ $vuetify.lang.t('$vuetify.global.button.skip') }}
      </v-btn>

      <v-spacer></v-spacer>
      
      <v-btn href="https://idphelp.sil.org/2sv-topics/security-key" target="_blank" color="primary" tabindex="-1" outlined class="mr-4 mb-4"> 
