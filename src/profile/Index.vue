  ...
  <BasePage>
    ...
    <v-row>
      <v-col>
        <v-footer>
          <small>
            <span v-for="(item, index) in googleItems" :key="index">
              {{ item.label + getSpaceCommaOrAnd(index, googleItems.length) }}
            </span>
...
export default {
  ...
  computed: {
    ...
    googleItems(vm) {
      return [
        ...
        {
          image:
            'https://lh3.googleusercontent.com/K0vgpnn9Vour8ByU3htR3ou5Cx70Me-lW_51VEAIS5dfzXCQ0otXakVuPiQVc0V6qcf9aP_vkVul59airN27m3mttf4zQ1TPv4MVrw',
        ...
        {
          image:
            'https://lh3.googleusercontent.com/rCwHBRBJV4wFiEIN_Mlboj94_TGJxyJtBh-MBFL4y1aZdO4hb7_Uc_PpXRyAoN7O9m_Zc1wSyp3H1vsnb829QE7t9KyGNJY9A1a3QQ',
        ...
        {
          image:
            'https://lh3.googleusercontent.com/hK3UrUgS8y0fmfFlxr7hQFdKdkufJQ5aDWjB9Ft2hTLkVUaZTWTH_w5AvXU3C4zko7w1RVLEUQf0DnQ_id9c32IZ6upSLMVfhSWnJg',
  ...
  methods: {
    ...
    getSpaceCommaOrAnd: (index, length) => (index === length - 1 ? '' : index === length - 2 ? ' and ' : ', '),
  },
  async created() {
