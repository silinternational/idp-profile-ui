...
1.  The app will be running on the domain configured for traefik, e.g., <https://dev1.gtis.guru>.
...
1. Enter app with a special "invitation" link, e.g., <https://dev1.gtis.guru/#/profile/intro?invite=2b2d424e-8cb0-49c7-8c0b-7f6603INVITE>
